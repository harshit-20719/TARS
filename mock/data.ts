...
const HALTEN_OBS: Observation[] = [
  { id: "o1", dealId: "halten", callNumber: 1, rubricKey: "pm", subDimensionKey: "problem-severity",
  ...
  { id: "o3", dealId: "halten", callNumber: 1, rubricKey: "pm", subDimensionKey: "why-now",
  ...
  { id: "o4", dealId: "halten", callNumber: 1, rubricKey: "ft", subDimensionKey: "execution",
  ...
  { id: "o9", dealId: "halten", callNumber: 1, rubricKey: "fl", subDimensionKey: "ip-boundary",
  ...
  { id: "o10", dealId: "halten", callNumber: 1, rubricKey: "gtm", subDimensionKey: "gtm-motion",
  ...
  { id: "o11", dealId: "halten", callNumber: 1, rubricKey: "pt", subDimensionKey: "foundational-tech",
    quote: "We think there's a platform play underneath it.", speaker: "Aparna", timestamp: "00:21", status: "draft", layer: "L1" },
  { id: "o12", dealId: "halten", callNumber: 1, rubricKey: "ft", subDimensionKey: "cofounder-dynamics",
...
const HALTEN_SCORES: SubDimensionScore[] = [
  ...
  { dealId: "halten", subDimensionKey: "execution", scoreType: "scale", value: 4, evidenceObsIds: ["o4"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "founder-narrative", scoreType: "scale", value: 4, evidenceObsIds: ["o1"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "coachability", scoreType: "scale", value: 4, evidenceObsIds: ["o8"], layer: "L1" },
  // cofounder-dynamics: unscored (its only observation was rejected).
  { dealId: "halten", subDimensionKey: "ambition-fit", scoreType: "binary", value: "pass", evidenceObsIds: ["o4"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "tech-self-suff", scoreType: "binary", value: "pass", evidenceObsIds: ["o4"], layer: "L1" },

  { dealId: "halten", subDimensionKey: "problem-severity", scoreType: "scale", value: 5, evidenceObsIds: ["o1"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "why-now", scoreType: "scale", value: 4, evidenceObsIds: ["o3"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "market-size", scoreType: "scale", value: 3, evidenceObsIds: [], layer: "L1" }, // incomplete (no evidence)
  ...
  { dealId: "halten", subDimensionKey: "defensibility", scoreType: "scale", value: "NE", evidenceObsIds: ["o6"], layer: "L1" }, // NE distinct from 1
  { dealId: "halten", subDimensionKey: "scalability", scoreType: "scale", value: 4, evidenceObsIds: ["o5"], layer: "L1" },
  // maturity: unscored

  { dealId: "halten", subDimensionKey: "privileged-access", scoreType: "scale", value: 5, evidenceObsIds: ["o7"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "icp-clarity", scoreType: "scale", value: 4, evidenceObsIds: ["o7"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "gtm-motion", scoreType: "scale", value: 2, evidenceObsIds: ["o10"], layer: "L1" },
  // sales-efficiency: unscored

  { dealId: "halten", subDimensionKey: "cap-table-health", scoreType: "binary", value: "pass", evidenceObsIds: ["o9"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "runway", scoreType: "binary", value: "pass", evidenceObsIds: [], layer: "L1" }, // incomplete
  { dealId: "halten", subDimensionKey: "ip-boundary", scoreType: "binary", value: "unv", evidenceObsIds: ["o9"], flag: true, layer: "L1" },
  { dealId: "halten", subDimensionKey: "regulatory", scoreType: "scale", value: 3, evidenceObsIds: [], layer: "L1" }, // incomplete

  { dealId: "halten", subDimensionKey: "thesis-fit", scoreType: "scale", value: 5, evidenceObsIds: ["o5"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "codev-leverage", scoreType: "scale", value: 4, evidenceObsIds: ["o10"], layer: "L1" },
  { dealId: "halten", subDimensionKey: "terms-fit", scoreType: "binary", value: "unv", evidenceObsIds: [], layer: "L1" },
];

const HALTEN_SLIDES: Slide[] = [
  { dealId: "halten", slideKey: "earned-secret", value: 6, provisionalValue: 8, lens: "peak", layer: "L1",
    ceilingGuard: "Ceiling set by earned insight (5). Banked at the L1 cap until the sector-insight claim verifies at L2." },
  ...
  { dealId: "halten", slideKey: "cornered-resource", value: 3, lens: "peak", layer: "L1",
    ceilingGuard: "Defensibility not yet evidenced (NE) — no cornered resource banked beyond the customer relationships." },
  { dealId: "halten", slideKey: "privileged-distribution", value: 5, provisionalValue: 7, lens: "peak", layer: "L1",
    ceilingGuard: "Two warm pilots (5) set the read; banked below cap until at least one pilot is contracted." },
  { dealId: "halten", slideKey: "gtm-engine", value: 3, lens: "weakest-link", layer: "L1",
    ceilingGuard: "Weakest-link: no repeatable motion yet (2) caps the engine, despite a sharp ICP (4). Studio-fillable." },
  { dealId: "halten", slideKey: "founder-storytelling", value: 5, provisionalValue: 6, lens: "peak", layer: "L1",
    ceilingGuard: "Clear, credible narrative (4); banked at 5, upside if the platform story sharpens." },
  { dealId: "halten", slideKey: "bmi", value: 4, lens: "peak", layer: "L1",
    ceilingGuard: "Per-account pricing with a platform thesis (4); conventional at L1, studio-fillable." },
  { dealId: "halten", slideKey: "idea", value: 6, provisionalValue: 8, lens: "peak", layer: "L1",
    ceilingGuard: "Peak: foundational tech / earned secret both at the L1 ceiling. Two critical pillars exceptional." },
  { dealId: "halten", slideKey: "founder", value: 6, lens: "weakest-link", layer: "L1",
    ceilingGuard: "Founder-track floor (earned insight) clears; execution and coachability both strong. Type: technical–domain hybrid." },
  { dealId: "halten", slideKey: "market", value: 5, lens: "weakest-link", layer: "L1",
    ceilingGuard: "Read after idea & founder cleared. Severe problem (5), but unverified market size (3) caps the track." },
];
...
const CIRRUS_OBS: Observation[] = [
  { id: "co1", dealId: "cirrus", callNumber: 1, rubricKey: "pm", subDimensionKey: "problem-severity",
  ...
  { id: "co3", dealId: "cirrus", callNumber: 1, rubricKey: "ft", subDimensionKey: "execution",
...
const CIRRUS_SCORES: SubDimensionScore[] = [
  { dealId: "cirrus", subDimensionKey: "problem-severity", scoreType: "scale", value: 4, evidenceObsIds: ["co1"], layer: "L1" },
  { dealId: "cirrus", subDimensionKey: "foundational-tech", scoreType: "scale", value: 4, evidenceObsIds: ["co2"], layer: "L1" },
  { dealId: "cirrus", subDimensionKey: "execution", scoreType: "scale", value: 4, evidenceObsIds: [], layer: "L1" },
  { dealId: "cirrus", subDimensionKey: "privileged-access", scoreType: "scale", value: 2, evidenceObsIds: ["co4"], layer: "L1" },
  { dealId: "cirrus", subDimensionKey: "cap-table-health", scoreType: "binary", value: "pass", evidenceObsIds: [], layer: "L1" },
  { dealId: "cirrus", subDimensionKey: "ambition-fit", scoreType: "binary", value: "pass", evidenceObsIds: [], layer: "L1" },
];
